class TestData:
    test_data_one = ['Аурелиано', 'Буэндиа', 'Макондо, 100', 'Китай-город', '79999999999', '30.01.2025', 'И приходился он самому себе дедушкой']

    test_data_two = ['Тайлер', 'Дёрден', 'Мыльная, 16', 'Деловой центр', '79999999999', '30.01.2025', 'Я полная невозмутимость Джека']

    test_data_answer_faq = [
